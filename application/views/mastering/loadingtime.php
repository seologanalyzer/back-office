...
<h3 class="page-title">Temps de chargement par Bing</h3>
<div class="row-fluid">
  <div class="span9">
    <div class="portlet box purple">
      ...
      <div class="portlet-body form" style="height:202px;">
        <div class="row-fluid">
          <div class="span12" id="charts_bing" style="height:202px;"></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="row-fluid">
  <div class="span12">
    <div class="portlet box purple">
      ...
      <div class="portlet-body form" style="height:202px;">
        <div class="row-fluid">
          <div class="span12" id="charts_hour_bing" style="height:202px;"></div>
        </div>
      </div>
    </div>
  </div>
...
<?php endforeach; ?>
  ...
  function chart2bing() {
    var pageviews = [
<?php foreach ($loadtime[2] as $date => $value): ?>
        [<?php echo strtotime($date); ?>000, <?php echo $value; ?>],
<?php endforeach; ?>
    ];
    ...
    var previousPoint = null;
    $("#charts_bing").bind("plothover", function(event, pos, item) {
      $("#x").text(pos.x.toFixed(2));
      $("#y").text(pos.y.toFixed(2));
  ...
  function chart2bisbing() {
    ...
    var ticks = [
<?php foreach ($loadhour[2] as $value): ?>
        [<?php echo $value->hour; ?>, <?php echo (int) $value->loading_time; ?>],
<?php endforeach; ?>
    ];
    ...
    var previousPoint = null;
    $("#charts_hour_bing").bind("plothover", function(event, pos, item) {
      $("#x").text(pos.x.toFixed(2));
      $("#y").text(pos.y.toFixed(2));
