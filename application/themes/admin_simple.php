...
<!--[if !IE]><!--> <html lang="<?php echo $this->lang->line('meta_language'); ?>"> <!--<![endif]-->
  ...
  <head>
    ...
    <link href="<?php echo assets_url('plugins/bootstrap-toastr/toastr.css'); ?>" rel="stylesheet" type="text/css"/>
    <!-- // Feuilles de style -->
  ...
  <body class="page-header-fixed">
      ...
      <div class="navbar-inner">
        <div class="container-fluid" style="padding-left:0px;">
          <a class="brand" href="<?php echo base_url() . 'dashboard'; ?>">
            <?php echo img('logo-mini.png', 'logo'); ?>
          </a>
    ...
    <script src="<?php echo assets_url('plugins/bootstrap-toastr/toastr.js'); ?>"></script>  
    <script>
